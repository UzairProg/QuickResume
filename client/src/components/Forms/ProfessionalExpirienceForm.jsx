...
function ProfessionalExpirienceForm({data, onChange}) {

  const [experience, setExperience] = React.useState(data || [])
  return (
    <div>
        ...
        <div className='flex justify-between w-full  pr-4 items-center'>
            ...
            <button className='group bg-gray-200 flex items-center gap-2 h-min py-1 px-2 rounded-md border border-transparent hover:bg-purple-200 hover:border-purple-400 transition-all'>
                ...
                <p className='text-sm text-purple-600'>Add Experience</p>
            </button>
        </div>

        {
            experience?.length == 0 ? (
              <div className='flex flex-col gap-3 mt-15 justify-center items-center'>
                ...
                <p className='text-gray-400 text-center'>No work experience added yet. <br/>Click "Add Experience" to get started.</p>
              </div>
            ) :
            (
              <div>
...
export default ProfessionalExpirienceForm
