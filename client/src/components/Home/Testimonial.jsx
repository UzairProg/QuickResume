...
const Testimonial = () => {
  const cardsData = [
    ...
    return (
        <div className=' flex flex-col items-center mt-20 px-4' id="testimonials">
            <style>{`
        ...
        `}</style>
            ...
            <div className='flex gap-3 border py-2 px-5 rounded-full items-center bg-blue-100/90 border-blue-300 '>
                <BookCheck className='text-blue-800/70 h-5'/>
                <p className='text-sm text-blue-700 font-medium'>Testimonial</p>
            </div>

            <TitleDescription title="What our users are saying" desc="Hear from our satisfied users who have transformed their job search with QuickResume."/>
