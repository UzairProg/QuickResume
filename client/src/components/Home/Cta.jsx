        ...
        <div className='' id='cta'>
            ...
            <section className="flex flex-col items-center justify-center mx-auto max-md:mx-2 max-md:px-2 max-w-5xl w-full text-center rounded-2xl py-16 bg-slate-100/70">
                ...
                <div className="flex gap-2">
                    <Link to="/app" className="px-8 py-2.5 mt-4 text-sm bg-indigo-600 hover:scale-105 transition duration-300 text-white">
                        Get Started
                    </Link>
                    <a href="https://github.com/UzairProg" target='_blank' className="flex items-center gap-2 px-8 py-2.5 mt-4 text-sm hover:scale-105 transition duration-300">
                        Github
